...
class SmartOrganizerApp(tk.Tk):
    ...
    def _build_action_buttons(self):
        ...
        self._btn_theme = tk.Button(frame, text=theme_icon, bg=t["SURFACE2"],
                                    activebackground=t["BG"], fg=t["TEXT"],
                                    padx=12, command=self._toggle_theme,
                                    **{k:v for k,v in btn_cfg.items() if k != "fg"})
        self._btn_theme.pack(side="left", padx=(0, 8))
    ...
    def _do_search(self):
        ...
        self._search_tree.tag_configure("low",  foreground=self._theme["MUTED"])
